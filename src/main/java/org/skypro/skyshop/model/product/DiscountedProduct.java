...
public class DiscountedProduct extends Product {
    ...
    public DiscountedProduct(UUID id, String name, int basicPrice, int discount) throws IllegalBasicPriceArgumentException, IllegalDiscountPriceArgumentException {
        super(id, name);
